...
__all__ = ["get_training_task_by_id", "save_training_task", "update_training_task_status"]
...
async def get_training_task_by_id(db: AsyncSession, task_id: UUID) -> TrainingTask | None:
